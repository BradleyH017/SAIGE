...
# bsub -o logs/saige_conditional-%J-%I-output.log -e logs/saige_conditional-%J-%I-error.log -q normal -G team152 -n 1 -M 9000 -a "memlimit=True" -R "select[mem>9000] rusage[mem=9000] span[hosts=1]" -J "saige_conditional[1-3901]%500" < testing_scripts/009-conditional_iterations.sh 
