...
# bsub -o logs/saige_prep-%J-output.log -e logs/saige_prep-%J-error.log -q long -G team152 -n 4 -M 150000 -a "memlimit=True" -R "select[mem>150000] rusage[mem=150000] span[hosts=1]" -J "saige_prep" < testing_scripts/003-prep_adata_per_resolution.sh 
